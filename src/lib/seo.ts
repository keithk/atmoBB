...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/admin/appearance/homepage': 'Homepage — Appearance — Admin',
  '/admin/appearance/branding': 'Branding — Appearance — Admin',
  '/admin/appearance/css': 'Custom CSS — Appearance — Admin',
