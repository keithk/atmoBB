...
import { getBoardIndex, getLatestThreads, FORUM_DID, type ForumFont, type ForumProfile } from '$lib/server/appview';
...
export const actions: Actions = {
  saveHomepage: async ({ request, locals }) => {
    ...
    await profileRedirect('/admin/appearance?saved=homepage', profile);
  },
