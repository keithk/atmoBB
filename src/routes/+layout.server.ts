...
export const load: LayoutServerLoad = async ({ locals, route }) => {
  ...
  if (!route.id) {
    return { user: locals.user, membership: null, avatarProfile: null, admin: false, staffRole: null, bans: [], ringSize: 0, forum, forumDid: FORUM_DID(), forumFontCss, forumCustomCss, forumFavicon, appviewDown: true, notifyOn: false, unread: 0 };
  }
